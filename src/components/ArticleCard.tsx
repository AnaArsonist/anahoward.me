	...
	return (
		...
		>
			<div className="flex ml-4 flex-col w-full justify-center">
				<div className="text-2xl xl:text-4xl md:text-4xl md:ml-5 font-bold text-gray-600 dark:text-gray-300 rounded-3xl">
					Articles
					<DocumentTextIcon className="inline-flex ml-2 w-5 md:w-10" />{' '}
				</div>
				<div className="mt-1 text-xs xl:text-2xl xl:mr-20 md:text-lg md:ml-5 dark:text-gray-300 text-gray-600 font-base">
